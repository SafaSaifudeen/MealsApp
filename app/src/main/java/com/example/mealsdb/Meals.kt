...
// Define the Meals entity class that represents a table in the database
@Entity//represents an entity,that can be persisted in a SQLite database using Room.
data class Meals(
    @PrimaryKey val id: Int,
    val meal: String?,
    val drinkAletrnate: String?,
    val category: String?,
    val area: String?,
